        ...
        <div class="container px-2 mt-md-5 px-md-5">
            <div class="row">
                <div class="col-12 col-md-6 pe-md-5 order-2 order-md-1">
                    <div class="row">
                        <div class="col-12">
                            <p class="categoryTitle">DINING</p>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="row mt-sm-3">
                                <div class="col-6">
                                    <p class="mb-2 titleNumberOfNight">DATE</p>
                                    <p class="titleNumberOfNightDetais mb-0">
                                        {{convertDateWithMonthNameDayYear($asset->check_in_datetime)}}</p>
                                </div>
                                <div class="col-6">
                                    <p class="mb-2 titlePrice">TIME</p>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <p class="mb-3 titleNumberOfNight">NUMBER OF GUESTS</p>
                                    <div class="d-flex">
                                        <p class="titleNumberOfNightDetaisIcon"><i class="fa fa-user me-2"
                                                aria-hidden="true"></i>
                                        </p>
                                        <p class="titleNumberOfNightDetais">{{$asset->asset_dining_info['number_of_guest'] ? $asset->asset_dining_info['number_of_guest']:0}}
                                        </p>
                                    </div>
                                </div>
                                <div class="col-6">
                            ...
                            <div class="d-flex btnInquiryDiv align-items-center justify-content-center my-3">
                                <button class="btnInquiry" id="makeInquiryBtnDinning" onclick="openInquireModal();">MAKE INQUIRE </button>
                            </div>
                        </div>
                    </div>
                    @endif
                ...
                <div class="col-12 col-md-6 ps-md-5 order-1 order-md-2 mb-4 mb-sm-0"
                    ...
                    @else
                    <img class="coverPhoto" src="{{asset('/assets/images/preview/dining-blank.png')}}">
                    @endif
                ...
                @if($asset->asset_status_id == App\ModelsExtended\AssetStatus::Available)
                    ...
                    @endif
                        ...
                        @endif
                    @if($asset->asset_dining_info['cancellation_policy'] != '')
                        <div class="col-12 col-md-6  moreInformation mt-2 mt-md-5 order-4 order-md-4">
                            <h5><a class="cancellation_policy_link" href="{{$asset->asset_dining_info['cancellation_policy']}}" target="_blank">CANCELLATION POLICY</a></h5>
                        </div>
                     @endif
                @endif
            </div>
