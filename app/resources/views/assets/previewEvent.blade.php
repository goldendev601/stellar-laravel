        ...
        <div class="container px-2 mt-md-5 px-md-5">
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="row mt-sm-3">
                                <div class="col-6">
                                    <p class="titleNumberOfNight">DATE</p>
                                    <p class="titleNumberOfNightDetais mb-0">
                                        {{convertDateWithDayName($asset->check_in_datetime)}}</p>
                                </div>
                                <div class="col-6">
                                    <p class="titlePrice">TIME</p>
                                    <p class="priceDetails mb-0">{{convertDateTOTime($asset->check_in_datetime)}}</p>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                <div class="col-6">
                                    <p class="mb-3 titleNumberOfNight">NUMBER OF TICKETS</p>
                                    <div class="d-flex">
                                        <p class="titleNumberOfNightDetaisIcon"><i class="fa fa-user me-2"
                                                aria-hidden="true"></i>
                                        </p>
                                        <p class="titleNumberOfNightDetais">{{$asset->asset_event_info['number_of_seats'] ? $asset->asset_event_info['number_of_seats']:0}}
                                        </p>
                                    </div>
                                </div>
                                <div class="col-6">
                            ...
                            <div class="d-flex btnInquiryDiv align-items-center justify-content-center my-3">
                                <button class="btnInquiry" id="makeInquiryBtnEvent" onclick="openInquireModal();">MAKE INQUIRE </button>
                            </div>
                        </div>
                    </div>
                    @endif
                ...
                <div class="col-12 col-md-6 ps-md-5 order-1 order-md-2 mb-4 mb-sm-0"
                    ...
                    @else
                    <img class="coverPhoto" src="{{asset('/assets/images/preview/event-blank.png')}}">
                    @endif
                ...
                @if($asset->asset_status_id == App\ModelsExtended\AssetStatus::Available)
                    @if($asset->asset_event_info->venue_layout != null)
                    <div class="col-12 col-md-6 pe-md-5 moreInformation mt-5 order-3 order-md-3">
                        <h5>SEATING CHART</h5>
                        <img class="mt-3 seatChartImg" src="{{$asset->asset_event_info->venue_layout}}">
                    </div>
                    @endif
                 @if( $asset->notes != '')
                    ...
                    @if( $asset->asset_event_info->cancellation_policy != '')
                        <div class="col-12 col-md-6 ps-md-5 moreInformation mt-2 mt-md-5 order-4 order-md-4">
                            <hr class="d-md-none mt-3">
                            <h5><a class="cancellation_policy_link" href="{{$asset->asset_event_info->cancellation_policy}}" target="_blank">CANCELLATION POLICY</a></h5>

                        </div>
                    @endif
                        @if( $asset->asset_event_info->venue_amenities != '')
                            <div class="col-12 col-md-6 ps-md-5 moreInformation mt-2 mt-md-5 order-4 order-md-4">
                                <hr class="d-md-none mt-3">
                                <h5>VENUE AMENITIES </h5>
                                <p>{{$asset->asset_event_info->venue_amenities}}</p>
                            </div>
                        @endif
                @endif
            </div>
