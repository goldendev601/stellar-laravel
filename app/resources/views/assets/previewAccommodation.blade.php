...
<div class="container-fluid">
    <div class="accoumodaton">
        ...
        <div class="container px-2 mt-md-5 px-md-5">
            <div class="row">
                <div class="col-12 col-md-6 pe-md-5 order-2 order-md-1">
                    <div class="row">
                        <div class="col-12">
                            <p class="categoryTitle">Accomodation</p>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <hr class="d-md-none mt-3">
                                <p class="dateTitle">Dates</p>
                            <p class="date">{{convertDateWithMonthNameDayYear($asset->check_in_datetime)}} –
                                {{convertDateWithMonthNameDayYear($asset->check_out_date)}}</p>
                            <hr>
                            <div class="row">
                                <div class="col-6">
                                    <p class="mb-3 titleNumberOfNight">NUMBER OF GUEST</p>
                                    <div class="d-flex">
                                        <p class="titleNumberOfNightDetaisIcon"><i class="fa fa-user me-2"
                                                aria-hidden="true"></i>
                                        </p>
                                        <p class="titleNumberOfNightDetais">{{$asset->asset_accommodation_info['number_of_guest'] ? $asset->asset_accommodation_info['number_of_guest']:0}}
                                        </p>
                                    </div>
                                </div>
                                @if($asset->asset_accommodation_info['number_of_night'] != null)
                                <div class="col-6">
                                    <p class="mb-3 titleNumberOfNight">NUMBER OF NIGHTS</p>
                                    <div class="d-flex">
                                        <p class="titleNumberOfNightDetaisIcon">
                                        </p>
                                        <p class="titleNumberOfNightDetais">{{$asset->asset_accommodation_info['number_of_night'] ? $asset->asset_accommodation_info['number_of_night']:0}}
                                        </p>
                                    </div>
                                </div>
                                @endif
                            ...
                            <div class="d-flex btnInquiryDiv  align-items-center justify-content-center my-5">
                                <button class="btnInquiry" id="makeInquiryBtnAcco" onclick="openInquireModal();">MAKE INQUIRE </button>
                            </div>
                        </div>
                    </div>
                    @endif
                ...
                <div class="col-12 col-md-6 ps-md-5 order-1 order-md-2 mb-4 mb-sm-0"
                    ...
                    @else
                    <img class="coverPhoto" src="{{asset('/assets/images/preview/accommodation-blank.png')}}">
                    @endif
                            ...
                            <nav class="nav-scroller">
                                <div class="nav-scroller-content">
                                    ...
                                    <a href="javascript:void(0)" class="nav-scroller-item"
                                        data-src="{{$image->image_url}}" onclick="openModal();currentSlide(3)"><img
                                            src="{{$image->image_url}}" alt="Image description"></a>
                                    @endforeach
                                    @endif
                                </div>
                            </nav>
                ...
                @if($asset->asset_status_id == App\ModelsExtended\AssetStatus::Available)
                    @if($asset->notes != '')
                        <div class="col-12 col-md-6 pe-md-4 moreInformation mt-4 order-3 order-md-3">
                            <h5>IMPORTANT EVENT INFORMATION</h5>
                            <p>{{$asset->notes}}</p>
                        </div>
                    @endif
                        @if($asset->asset_accommodation_info['cancellation_policy'] != '')
                            <div class="col-12 col-md-6 ps-md-5 moreInformation mt-2 mt-md-5 order-4 order-md-4">
                                <h5><a class="cancellation_policy_link" href="{{$asset->asset_accommodation_info['cancellation_policy']}}" target="_blank">CANCELLATION POLICY</a></h5>
                            </div>
                        @endif
{{--                        @if($asset->asset_accommodation_info['cancellation_cost'] != '')--}}
{{--                            <div class="col-12 col-md-6  moreInformation mt-2 mt-md-5 order-4 order-md-4">--}}
{{--                                <h5><a class="cancellation_policy_link" href="{{$asset->asset_accommodation_info['cancellation_cost']}}">CANCELLATION COST</a></h5>--}}
{{--                            </div>--}}
{{--                        @endif--}}
                        @if($asset->asset_accommodation_info['website'] != '')
                            <div class="col-12 col-md-6  moreInformation mt-2 mt-md-5 order-4 order-md-4">
                                <h5>WEBSITE</h5>
                                <p>{{$asset->asset_accommodation_info['website']}}</p>
                            </div>
                        @endif
                @endif
            </div>
        ...
        <div class="row d-flex align-items-end previewfooter">
            <div class="col-6">
                <img src="{{ asset('/assets/images/preview/brandLogo.png') }}">
            </div>
...
<div id="myModal" class="modal">
    <!-- <div style="padding: 0 2.5rem  !important;">
        <img class="modalLogo" src="{{ asset('/assets/images/preview/brandLogo.png') }}">
    </div> -->
