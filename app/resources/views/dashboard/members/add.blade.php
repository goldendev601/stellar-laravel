        ...
        <div class="row second-chart-list third-news-update">
            <div class="xl-100 morning-sec box-col-12">
                <div class="card o-hidden">
                    <div class="card-body">
                        <form method="post" action="{{ route('members.insert') }}" id="addnewContactFrom"
                              enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-12 d-flex justify-content-between">
                                    <h6 class="f-w-700">ADD NEW CONTACT</h6>

                                    <div class="uploadPhotoPreview">
                                        <label class="cabinet">
                                            <img src="" class="img-responsive uploadPhotoPreview" id="item-img-output"/>
                                            <figcaption><i class="fa fa-camera"></i></figcaption>
                                            <input type="file" class="item-img file" name="imageDemo"/>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mt-4">
                                    ...
                                    <input class="form-control f-sf-pro" type="text" name="last_name" required>
                                    <span class="text-danger error_last_name f-sf-pro"></span>

                                </div>
                                <div class="col-md-6 mt-4">
                                    <label class="form-label f-sf-pro">PHONE: *</label>
                                    <input class="form-control f-sf-pro" type="tel" name="msisdn" required
                                           maxlength="30"
                                ...
                                <div class="col-md-6 mt-4">
                                    ...
                                    <input class="form-control f-sf-pro" type="text" name="zipcode" required>
                                    <span class="text-danger error_zipcode f-sf-pro"></span>
                                </div>
                                <div class="col-md-6 mt-4">
                                    ...
                                    <span
                                        class="text-danger error_member_status_id f-sf-pro">{{ $errors->first('is_active') }}</span>

                                </div>
                                <div class="col-md-12 mt-4">
                                    <label class="form-label f-sf-pro">INTERESTS</label>
                                    <div class="form-group has-search f-sf-pro">
                                        <span class="fa fa-search form-control-feedback"></span>
                                        <input type="text" value="" class="form-control f-sf-pro" id="tags_interest"
                                               name="interests">
                                    </div>
                                </div>
                                <div class="col-md-12 mt-4">
                                    <label class="form-label f-sf-pro">Group</label>
                                    <div class="form-group has-search f-sf-pro">
                                        <span class="fa fa-search form-control-feedback"></span>
                                        <input type="text" value="" class="form-control f-sf-pro" id="tags_groups"
                                               name="groups">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 d-flex justify-content-end ">
                                    <a class="btn mt-4 addContactCancelBtn" href="{{ route('members')}}">Cancel</a>
                                    <button class="btn btn-primary mt-4 addContactBtn" type="submit">Add Contact
                                    </button>
                                </div>
                            </div>
                        </form>
...
@section('script')
    ...
    <script>
        $(document).ready(function () {
            ...
            $(".uploadPhotoPreview").attr("src", "{{ asset('assets/images/avtar/avatar-placeholder.jpg') }}");
            var $uploadCrop,
                tempFilename,
                rawImg,
                imageId;
